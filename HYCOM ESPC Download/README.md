# Download HYCOM ESPC-D-V02: Global 1/12° Analysis Outputs

1. You can download HYCOM ESPC-D-V02 outputs with this code.
2. You can **set the Period, Area, Depth, temporal resolution, number of (lon, lat) grid interval** of the data. 
...
https://github.com/wenfanwu/get_hycom_online (available)

[Other Available Toolbox for HYCOM GOFS 3.1]
If you need HYCOM GOFS 3.1 Analysis or Reanalysis version, use below toolbox.
https://kr.mathworks.com/matlabcentral/fileexchange/173220-hycom-download-hycom-gofs-3-1?s_tid=prof_contriblnk 
