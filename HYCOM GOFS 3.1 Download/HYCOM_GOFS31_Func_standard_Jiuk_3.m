function HYCOM_GOFS31_Func_standard_Jiuk_3(Period, timestep, Spatial_area, lat_step, lon_step, Depth_range, VariableData, HomeFolderNm, RawDataFolderNm, MatFileNm, HYC_ver)
...
%
%       HYCOM_GOFS31_Func_standard_Jiuk_3.m
%       2025.04.20 Update (1)
%                   1. now you can change the interval of lon, lat grid 
% =========================================================================
...
HycSetTime(8,1) = datetime(2019,01,01,00,00,00);    HycSetTime(8,2) = datetime(2024,09,04,21,00,00);
            ...
            if any(dateID_re)
                ...
                if ~isempty(id_tm)
                    for loopdown = 1:length(id_tm)
                        ...
                        hyc = hyc_down_specific_area(ads1, id_tm(loopdown), id_la, id_lo, id_dep, varcheck, lat_step, lon_step);
...
function hyc = hyc_down_specific_area(ads1, id_tm, id_la, id_lo, id_dep, varcheck, lat_step, lon_step)
